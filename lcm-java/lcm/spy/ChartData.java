...
/**
 * Global class allowing multiple charts to know about each other and make intelligent decisions
 * based on that.
 *
 * <p>Also ensures that we do not try to create two charts based on the same data backend, which can
 * cause conflicts.
 *
 * @author abarry
 */
