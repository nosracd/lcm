 ...
 *
 * <p>The key is the time in ms and may be used in a Map. <code>{@link #compareTo(TimeStampedValue)}
 * </code> compares the key.
 *
...
public final class TimeStampedValue
  ...
  /**
   * The time stamp (difference, measured in milliseconds, between the current time and midnight,
   * January 1, 1970 UTC).
   */
   ...
   * <p>
   *
   * @param key the time stamp (difference, measured in milliseconds, between the current time and
   *     midnight, January 1, 1970 UTC).
   * @param value the value to time stamp.
   */
  ...
  /**
   * Returns the {@link Long} that marks the time stamp (difference, measured in milliseconds,
   * between the current time and midnight, January 1, 1970 UTC).
   *
   * @return the {@link Long} that marks the time stamp (difference, measured in milliseconds,
   *     between the current time and midnight, January 1, 1970 UTC).
  ...
  /**
   * Returns the time stamp (difference, measured in milliseconds, between the current time and
   * midnight, January 1, 1970 UTC).
   *
   * <p>
   *
   * @return the time stamp (difference, measured in milliseconds, between the current time and
   *     midnight, January 1, 1970 UTC).
   */
  public long getTime() {
    return this.m_key;
   ...
   *
   * <p>For normal a time stamp represents a value regarded at a time. But it is also thinkable to
   * mark a value for expiration in the future. This method returns true if the internal time-
   * representing key is smaller than the actual time.
   *
   * <p>
   *
   * @return true if the internal time stamp marks a moment in the past, false else.
   */
   ...
   * <p>
   *
   * @param value the new value to be marked with this timestamp.
