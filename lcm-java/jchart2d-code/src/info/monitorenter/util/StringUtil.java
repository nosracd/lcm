 ...
 *
 * <p>Maybe not always the fastest solution to call in here, but working. Also usable for seeing
...
public final class StringUtil {
   ...
   *
   * <p>Not intended for big append -operations because in a loop alway just one space is added.
   *
   * <p>
   *
   * @param s the base String to append spaces to.
   * @param count the amount of spaces to append.
   ...
   *
   * <p>What is special? <br>
   * If an Object in the given List is an Array (of Objects or primitive data types) reflection will
   ...
   *
   * <p>Avoid structural modifications (remove) of the list while using this method. This method or
   * better: the given List is only thread - safe if the list is synchronized.
   *
   * <p>A clever VM (hotspot) will be able to inline this function because of void return.
   *
   * <p>
   *
   * @param objects the List of objects that will be changed to a list of the String representation
   *     of the Objects with respect to special array treatment.
   */
  ...
  /**
   * If the given Object is no Array, it's toString - method is invoked. Primitive type - Arrays and
   * Object - Arrays are introspected using java.lang.reflect.Array. Convention for creation for
   ...
   *
   * <p>Only call this method once (not in a loop) and keep the result.
   *
   * <p>
   *
   ...
   *
   * <p>This method is useless for now as all methods are static. It may be used in future if
   * VM-global configuration will be put to the state of the instance.
   *
   * <p>#
   *
   ...
   * List.
   *
   * <p>No data is changed in the given List at all. But the String - representation of all Objects,
   ...
   * </pre>
   *
   * @param objects the <code>List&lt;Object&gt;</code> to inspect for the maximum length of a
  ...
  public static final String setSize(final String s, final int length) {
    ...
    if (oldlen > length) {
      System.err.println(
          "greenpeace.util.setSize(String s,int length): length ("
              + length
              + ") is smaller than s.length("
              + oldlen
              + ") : "
              + s);
    } else {
   ...
   * representation concatenated with the necessary amount of white spaces that every String in the
   * List will have the same amount of characters.
   *
   * <p>Only use this method in following case: <br>
   *
   * <ul>
   *   <li>You have got an AbstractList or subclass containing Objects you do not know.
   *   <li>You want to transform all Elements in the List to Strings.
   ...
   *
   * <ul>
   *   <li>All Objects, even primitive Arrays in your List will be turned to String- representation.
   *   <li>The result will replace the old position of the Object in the given List. The old Objects
   *       will get lost!
   *   <li>All Strings will be filled with whitespaces until each String has the same length.
   * </ul>
   *
   ...
   * <p>
   *
   * @param objects contains the Objects to replace by their toString() representation.
   */
