...
public class HSBColor implements java.io.Serializable, Cloneable {
   ...
   * Testing results showed about 25% speed up. Therefore the sources have become harder to
   * understand.
   *
   * @param color the <code>java.awt.Color</code> (that follows the RGB model) and should be
   *     transformed to a color instance in the hue-saturation-luminance model.
  ...
  /**
   * The unused alpha channel between 0 and 255: stored here for allow java.awt.Color instances to
   * be transformed to instances of this class and be re - transformed with preserving their alpha
   * setting.
   */
  ...
  /**
   * Creates an instance with the given values for hue saturation, luminance and alpha.
   *
   * <p>
   *
   * @param hue the hue component of the HSBColor
   * @param saturation the saturation component of the HSBColor
   * @param brightness the brightness component of the HSBColor
   * @param alpha the alpha channed between 0.0 and 1.0.
   */
   ...
   * <p>
   *
   * @param rgbcolor standard java rgb color.
   */
   ...
   *
   * <p>Following statements are true: <br>
   * <code>
   *  x.clone() != x
  ...
  public java.awt.Color getRGBColor() {
    final int rgb =
        java.awt.Color.HSBtoRGB((float) this.m_hue, (float) this.m_sat, (float) this.m_lum);
