...
/**
 * Singleton <code>Action</code> that sets a custom background color of the corresponding <code>
...
public final class JComponentActionSetCustomBackgroundSingleton extends AJComponentAction {
  ...
  static {
    JComponentActionSetCustomBackgroundSingleton.instances =
        new HashMap<String, JComponentActionSetCustomBackgroundSingleton>();
  }
  ...
  public static JComponentActionSetCustomBackgroundSingleton getInstance(
    ...
    JComponentActionSetCustomBackgroundSingleton result =
        JComponentActionSetCustomBackgroundSingleton.instances.get(
            JComponentActionSetCustomBackgroundSingleton.key(component));
    if (result == null) {
   ...
   *
   * @param component the component to create the key for internal storage.
   ...
   */
  private JComponentActionSetCustomBackgroundSingleton(
      final JComponent component, final String description) {
