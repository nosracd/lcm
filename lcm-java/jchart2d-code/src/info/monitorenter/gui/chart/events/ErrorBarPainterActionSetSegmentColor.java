...
/**
 * <code>Action</code> that sets a custom color to the corresponding segment of an error bar painter
...
public final class ErrorBarPainterActionSetSegmentColor extends AbstractAction {
  ...
  /**
   * Needed as the parent UI component of the modal dialog which will be blocked by the modal color
   * chooser dialog that pops up.
   */
  private JComponent m_dialogParent;

  /**
   * Create an <code>Action</code> that accesses the error bar painter and identifies itself with
   * the given action String.
   *
   * @param errorBarPainterFacade the target the action will work on.
   * @param dialogParent needed as the parent UI component of the modal dialog which will be blocked
  ...
  public ErrorBarPainterActionSetSegmentColor(
      final IErrorBarPainter.ISegment errorBarPainterFacade,
  ...
  public void actionPerformed(final ActionEvent e) {
    Color chosen =
        JColorChooser.showDialog(
            this.m_dialogParent,
            "choose color for " + this.m_segment.getName(),
            this.m_segment.getColor());
