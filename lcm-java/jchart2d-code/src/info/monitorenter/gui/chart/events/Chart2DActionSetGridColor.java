...
/**
 * Performs the action of setting the color of gridlines ( {@link
 * info.monitorenter.gui.chart.Chart2D#setGridColor(Color)}) of a <code>Chart2D</code> with the
 * constructor given <code>Color</code>.
 *
 * <p>
 *
...
public class Chart2DActionSetGridColor extends AChart2DAction {
   ...
   * @param color the color of gridlines to set.
   */
