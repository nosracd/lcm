...
/**
 * Action that sets a constructor given {@link info.monitorenter.gui.chart.IRangePolicy} to a
...
public class AxisActionSetRangePolicy extends AAxisAction {
  ...
  /**
   * The range policy to set to the axis upon invocation of {@link #actionPerformed(ActionEvent)}.
   */
   ...
   * String and sets the given {@link info.monitorenter.gui.chart.IRangePolicy} to the axis upon
   * selection.
   *
   * <p>
   *
   ...
   *     Chart2D#Y}.
   * @param rangePolicy the range policy to set oon the axis.
   ...
   */
  public AxisActionSetRangePolicy(
      final Chart2D chart,
