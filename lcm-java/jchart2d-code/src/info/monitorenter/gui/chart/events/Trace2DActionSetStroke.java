...
/**
 * <code>Action</code> that sets a constructor-given zIndex to the corresponding trace.
 *
...
public final class Trace2DActionSetStroke extends ATrace2DAction {
   ...
   * @param stroke the stroke property to set to the corresponding trace (see {@link
   *     ITrace2D#setStroke(Stroke)})
   */
  public Trace2DActionSetStroke(
      final ITrace2D trace, final String description, final Stroke stroke) {
