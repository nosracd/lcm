...
public final class Chart2DActionPrintSingleton extends AChart2DAction {
  ...
  /** Map for instances. */
  private static Map<String, Chart2DActionPrintSingleton> instances =
      new HashMap<String, Chart2DActionPrintSingleton>();
  ...
  public static Chart2DActionPrintSingleton getInstance(final Chart2D chart) {
    Chart2DActionPrintSingleton result =
        Chart2DActionPrintSingleton.instances.get(Chart2DActionPrintSingleton.key(chart));
    return result;
  }
   ...
   */
  public static Chart2DActionPrintSingleton getInstance(
   ...
   *
   * <p>This signals the chart that is painting that a print cycle is running triggered by this
   * action and the chart should be printed on the whole page.
   *
   * <p>Requesting this value has to be synchronized together with the method <code>
   * {@link Chart2D#paint(java.awt.Graphics)}</code> method and reset to false from there.
   *
   * <p>
   */
   ...
   *
   * <p>Has to be called by <code>{@link Chart2D#paint(java.awt.Graphics)}</code> when printing was
   * triggered from here.
   *
   * <p>
   */
