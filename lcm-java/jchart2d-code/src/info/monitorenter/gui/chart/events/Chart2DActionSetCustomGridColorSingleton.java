...
/**
 * Singleton <code>Action</code> that sets a custom grid color to the corresponding chart ({@link
...
public final class Chart2DActionSetCustomGridColorSingleton extends AChart2DAction {
  ...
  static {
    Chart2DActionSetCustomGridColorSingleton.instances =
        new HashMap<String, Chart2DActionSetCustomGridColorSingleton>();
  }
  ...
  public static Chart2DActionSetCustomGridColorSingleton getInstance(
    ...
    Chart2DActionSetCustomGridColorSingleton result =
        Chart2DActionSetCustomGridColorSingleton.instances.get(
            Chart2DActionSetCustomGridColorSingleton.key(chart));
    if (result == null) {
