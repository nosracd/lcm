...
/**
 * Performs the action of setting a trace visible ( {@link
 * info.monitorenter.gui.chart.ITrace2D#setVisible(boolean)}) with the constructor given boolean.
 *
 * <p><b>This action only may be assigned to a {@link javax.swing.JCheckBoxMenuItem}</b> <br>
 * The <em>source</em> <code>Object</code> of <code>ActionEvent</code> that is received in {@link
 * #actionPerformed(ActionEvent)} is casted to this type to get the boolean state. If this <code>
 * Action</code> is used with other <code>JComponent</code> instances <code>ClassCastExceptions
 * </code> will be thrown!
 *
