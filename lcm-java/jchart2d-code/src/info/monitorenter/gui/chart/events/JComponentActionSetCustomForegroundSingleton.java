...
/**
 * Singleton <code>Action</code> that sets a custom foreground color of the corresponding <code>
 * JComponent</code> by showing a modal color chooser.
 *
...
public final class JComponentActionSetCustomForegroundSingleton extends AJComponentAction {
  ...
  static {
    JComponentActionSetCustomForegroundSingleton.instances =
        new HashMap<String, JComponentActionSetCustomForegroundSingleton>();
  }
   ...
   * <p>
   *
   * @param component the component to get the instance for (works as key).
   * @param description the description to use (ignored if instance for component has been created
   *     before).
  ...
  public static JComponentActionSetCustomForegroundSingleton getInstance(
    ...
    JComponentActionSetCustomForegroundSingleton result =
        JComponentActionSetCustomForegroundSingleton.instances.get(
            JComponentActionSetCustomForegroundSingleton.key(component));
    if (result == null) {
   ...
   *
   * @param component the component for the internal storage key to compute.
   ...
   */
  private JComponentActionSetCustomForegroundSingleton(
      final JComponent component, final String description) {
  ...
  public void actionPerformed(final ActionEvent e) {
    Color chosen =
        JColorChooser.showDialog(
            this.m_component,
            "choose background color for " + this.m_component.getName(),
