...
/**
 * Performs the action of setting the foreground color ( {@link
 * javax.swing.JComponent#setForeground(java.awt.Color)}} of a <code>JComponent</code>.
 *
 * <p>
 *
...
public final class JComponentActionSetForeground extends AJComponentAction {
   ...
   * @param color the <code>Color</code> to set as "foreground" of the internal <code>JComponent
   *     </code>.
   */
  public JComponentActionSetForeground(
