...
/**
 * <code>Action</code> that sets a custom name of the corresponding trace by showing a modal String
 * chooser.
 *
 * <p>
 *
...
public final class Trace2DActionSetName extends ATrace2DAction {
   ...
   * @param trigger the <code>Component</code> the modal dialog will be related to.
   */
  public Trace2DActionSetName(
  ...
  public void actionPerformed(final ActionEvent e) {
    String chosen =
        JOptionPane.showInputDialog(
            this.m_trigger,
            "Please input the new Name for trace " + this.m_trace.getName(),
            "Set trace name",
