...
/**
 * <code>Action</code> that sets an <code>{@link IPointPainter}</code> to the corresponding segment
 * of an error bar painter.
 *
 * <p>
 *
...
public final class ErrorBarPainterActionSetSegmentPainter extends AbstractAction {
   ...
   * @param pointPainter the point painter to set to the segment of the error bar painter.
  ...
  public ErrorBarPainterActionSetSegmentPainter(
      ...
      final IPointPainterConfigurableUI<?> pointPainter,
      final String name) {
    super(name);
