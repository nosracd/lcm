...
/**
 * Action that pops up a modal dialog to edit the given <code>
 * {@link info.monitorenter.gui.chart.IErrorBarPainter}</code>.
 *
 * <p>
 *
...
public class ErrorBarPainterActionEdit extends AErrorBarPainterAction {
   ...
   *
   * @param errorBarPainter the target the action will work on.
   ...
   * @param dialogParent the parent component for the modal dialog.
   */
  public ErrorBarPainterActionEdit(
  ...
  public void actionPerformed(final ActionEvent e) {
    ...
    ModalDialog dialog =
        new ModalDialog(
            this.m_dialogParent, "title", new ErrorBarPainterEditPanel(this.m_errorBarPainter));
