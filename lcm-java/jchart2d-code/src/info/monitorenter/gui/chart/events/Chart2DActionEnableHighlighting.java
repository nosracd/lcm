...
public class Chart2DActionEnableHighlighting extends AChart2DAction {
  ...
  /**
   * Creates an <code>Action</code> that will invoke <code>
   * {@link Chart2D#enablePointHighlighting(boolean)}</code> with the state of the triggering <code>
   * {@link ItemSelectable}</code>
   *
   * <p>
   *
