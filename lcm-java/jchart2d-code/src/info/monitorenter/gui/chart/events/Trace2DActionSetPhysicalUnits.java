...
/**
 * <code>Action</code> that sets custom physical units for x and y on the corresponding trace by
...
public final class Trace2DActionSetPhysicalUnits extends ATrace2DAction {
   ...
   */
  public Trace2DActionSetPhysicalUnits(
  ...
  public void actionPerformed(final ActionEvent e) {
    TwoStringsChooserPanel ui =
        new TwoStringsChooserPanel(
            "x", this.m_trace.getPhysicalUnitsX(), "y", this.m_trace.getPhysicalUnitsY());
    ModalDialog dialog =
        new ModalDialog(this.m_trigger, "Enter the physical units for each dimension", ui);
    dialog.showDialog();
