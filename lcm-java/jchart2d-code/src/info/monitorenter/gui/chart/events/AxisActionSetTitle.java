...
/**
 * <code>Action</code> that sets the title String of the <code>{@link IAxis}</code> specified by the
 * constructor.
 *
 * <p>
 *
...
public class AxisActionSetTitle extends AAxisAction {
  ...
  public void actionPerformed(final ActionEvent e) {
    ...
    OneStringChooserPanel titlePanel =
        new OneStringChooserPanel("Title", axis.getAxisTitle().getTitle());
    ModalDialog dialog =
        new ModalDialog(
            axis.getAccessor().getChart(),
            "Choose a Title for the " + axis.toString() + " axis",
            titlePanel);
    dialog.showDialog();
