...
/**
 * <code>Action</code> that sets a custom foreground color of the corresponding <code>JComponent
 * </code> by showing a modal color chooser.
 *
  ...
  public void actionPerformed(final ActionEvent e) {
    Color chosen =
        JColorChooser.showDialog(
            this.m_component,
            "choose foreground color for " + this.m_component.getName(),
            this.m_component.getForeground());
