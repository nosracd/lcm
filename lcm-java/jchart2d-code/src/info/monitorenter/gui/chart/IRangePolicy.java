 ...
 *
 * <p>Implementations may limit the range of the underlying Chart2D's data (clipping / zooming),
 * increase it (void space offset), guarantee a minimum viewport... .
 *
 * <p>
 *
...
public interface IRangePolicy extends Serializable {
  /**
   * The property key defining a change of the <code>min</code> or the <code>max</code> property.
   *
  ...
  /**
   * Define the upper bound of the Chart2D's value range. Depends on the {@link
   * info.monitorenter.gui.chart.axis.AAxis} this instance is bound to.
   *
   * @param chartMin the minimum value of the connected Chart2D that may / should be taken into
   *     account.
   * @param chartMax the maximum value of the connected Chart2D that may / should be taken into
   *     account.
  ...
  /**
   * Define the lower bound of the Chart2D's value range. Depends on the {@link
   * info.monitorenter.gui.chart.axis.AAxis} this instance is bound to.
   *
   * @param chartMin the minimum value of the connected Chart2D that may / should be taken into
   *     account.
   ...
   * <p>
   *
   * @param range the Range for the range policy.
   */
