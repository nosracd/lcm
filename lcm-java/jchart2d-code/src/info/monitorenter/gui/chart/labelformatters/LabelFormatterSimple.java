...
/**
 * An IlabelFormatter implementation that just returns <code>String.valueOf(value)</code>.
 *
 * <p>
 *
 ...
 */
public final class LabelFormatterSimple extends LabelFormatterNumber
  ...
  /**
   * Default constructor that limits the internal maximum fraction digits to 2 and the maximum
   * integer digits to 16.
   *
   * <p>
   */
