...
public abstract class ATracePainter
    implements info.monitorenter.gui.chart.ITracePainter<ATracePainter> {
  ...
  /**
   * The last trace point that was sent to {@link #paintPoint(int, int, int, int, Graphics,
   * ITracePoint2D)}.
   *
  ...
  /**
   * Returns the previous trace point that had to be painted by {@link #paintPoint(int, int, int,
   * int, Graphics, ITracePoint2D)}.
   *
   * <p>This value will be <code>null</code> if no previous point had to be painted.
   *
   * <p>
   *
   * @return the previous trace point that had to be painted by {@link #paintPoint(int, int, int,
   *     int, Graphics, ITracePoint2D)}.
   */
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((this.m_previousPoint == null) ? 0 : this.m_previousPoint.hashCode());
