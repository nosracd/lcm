...
/**
 * An <code>{@link info.monitorenter.gui.chart.ITracePainter}</code> implementation that works on a
 * given <code>{@link IPointPainter}</code>.
 *
 * <p>
 *
 * @author <a href="mailto:Achim.Westermann@gmx.de">Achim Westermann </a>
 * @version $Revision: 1.14 $
 * @param <T> needed for comparable<T>.
 */
