...
/**
 * A range policy that forces the chart only to display the bounds of the internal range regardless
 * of the actual bounds of the traces within the chart.
 *
 * <p>
 *
