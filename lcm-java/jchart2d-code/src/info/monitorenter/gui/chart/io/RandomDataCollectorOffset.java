 ...
 *
 * <p>Only collects random values with timestamp on the x axis. The timestamp is related to the time
 * when this instance is instantiated to make it a lower value (offset to start). implementation for
 * exact timestamps that may be formatted with java.text.DateFormat instances.
 *
 * <p>
 *
...
public class RandomDataCollectorOffset extends ADataCollector {
   ...
   * @param latency the interval for collection of points.
   */
