...
/**
 * Defines the tool tips to display on a <code>{@link Chart2D}</code>.
 *
 * <p>
 *
...
public interface IToolTipType {
  ...
  /**
   * The base class implementation that returns the tool tip text for the given mouse event which is
   * a NONE implementation here.
   *
   * <p>
   *
   * @param chart the chart for computation of tool tips.
   * @param me the corresponding mouse event.
