...
public class ErrorBarPainterEditPanel extends JPanel {
  ...
  /**
   * Base implementation that allows selection of an <code>
   * {@link info.monitorenter.gui.chart.IPointPainter}</code> and it's <code>{@link java.awt.Color}
   * </code> and holds the parental <code>{@link IErrorBarPainter}</code> to assign the painter to
   * (as a segment: start, end or connetion).
   *
   * <p>Implementations have to add the action listeners that defines to which segment of the <code>
   * {@link IErrorBarPainter}</code>. the configured painter will set to.
   *
   * <p>
   *
   * @author <a href="mailto:Achim.Westermann@gmx.de">Achim Westermann</a>
  ...
  private class SegmentChooserPanel extends JPanel {
     ...
     * <code>{@link IErrorBarPainter.ISegment}</code> and sets the color to the constructor given
     * <code>{@link ColorIcon}</code>.
     *
     * <p>
     *
     * @author <a href="mailto:Achim.Westermann@gmx.de">Achim Westermann</a>
    ...
    final class ColorIconUpdater implements PropertyChangeListener {
       ...
       * <p>
       *
       * @param adaptee the color icon to adapt the color property of the segment to.
       */
      ...
      public void propertyChange(final PropertyChangeEvent evt) {
        ...
        if (ErrorBarPainterEditPanel.SegmentChooserPanel.this
            .m_segment
     ...
     * <p>
     *
     * @param errorBarPainterSegement the error bar painter segment to configure.
     */
    public SegmentChooserPanel(final IErrorBarPainter.ISegment errorBarPainterSegement) {
      ...
      this.setBorder(
          BorderFactory.createTitledBorder(
              ...
              errorBarPainterSegement.getName(),
              TitledBorder.LEFT,
      ...
      // Color selector:
      final AbstractAction colorAction =
          new ErrorBarPainterActionSetSegmentColor(errorBarPainterSegement, this, "color");
      ...
      action =
          new ErrorBarPainterActionSetSegmentPainter(
              errorBarPainterSegement, pointPainter, "Empty");
      ...
      painterSelector.addActionListener(
          new ActionListener() {
      ...
      errorBarPainterSegement.addPropertyChangeListener(
          errorBarPainterSegement.getPropertySegmentColor(), new ColorIconUpdater(colorIcon));
   ...
   * <p>
   *
   * @param errorBarPainter the error bar painter to configure.
   */
