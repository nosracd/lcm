 ...
 *
 * <p>It acts as a facade for an <code>{@link info.monitorenter.gui.chart.ITracePainter}</code> with
 * configurable <code>{@link info.monitorenter.gui.chart.IErrorBarPainter}</code> instances that
 ...
 *
 * The following table describes the contract of this interface of <code>
 * {@link java.beans.PropertyChangeEvent}</code> instances that are thrown by methods.
 *
 * <table border="0">
 * <tr>
...
public interface IErrorBarPolicy<T extends IErrorBarPolicy<T>> extends ITracePainter<T> {
   ...
   *
   * <p>This is fired whenever the internal configuration of the error bar policy changes. This
   ...
   *
   * <p>As it is of no interest and knowledge which configuration has changed the {@link
   * java.beans.PropertyChangeEvent#getNewValue()} and the {@link
   * java.beans.PropertyChangeEvent#getOldValue()} of the {@link java.beans.PropertyChangeEvent}
   * given to {@link PropertyChangeListener#propertyChange(java.beans.PropertyChangeEvent)} of
   * listeners should be null always.
   *
   ...
   *
   * <p>Namely from <code>{@link  #addErrorBarPainter(IErrorBarPainter)}</code> <code>
   * {@link #setErrorBarPainter(IErrorBarPainter)}</code> and <code>
   * {@link #removeErrorBarPainter(IErrorBarPainter)}</code>.
   *
   * <p>Use in combination with {@link #addPropertyChangeListener(String, PropertyChangeListener)}.
   *
   * <p>
   ...
   * <p>
   *
   * @param xPixel the x value in pixel to render an error bar for.
   * @param yPixel the y value in pixel to render an error bar for.
   * @param errorBar an error bar to use: This is for design reasons as internally this method is
   *     used too with a reused instance.
   * @param original the original point, possibly useful for calculations.
   */
  public void calculateErrorBar(
      final int xPixel,
      final int yPixel,
   ...
   *
   * <p>Returns a <code>JComponent</code> that - stand alone - takes care of configuring custom
   ...
   * <p>
   *
   * @param xValue the absolute x value (not pixel) to get the error for.
   ...
   * <p>
   *
   * @param yValue the absolute y value (not pixel) to get the error for.
   ...
   * <p>
   *
   * @param painter the error bar painter to remove.
   ...
   * <p>
   *
   * @param showNegativeXErrors if true negative errors in x dimension will be shown.
   */
   ...
   * <p>
   *
   * @param showNegativeYErrors if true negative errors in y dimension will be shown.
   */
   ...
   * <p>
   *
   * @param showPositiveXErrors if true positive errors in x dimension will be shown.
   */
   ...
   * <p>
   *
   * @param showPositiveYErrors if true positive errors in y dimension will be shown.
   */
