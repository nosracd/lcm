...
/**
 * A chart to test labels. This chart uses a <code>
 * {@link info.monitorenter.gui.chart.labelformatters.LabelFormatterNumber}</code> that formats to
...
public class StaticCollectorChart extends JPanel {
  ...
  /**
   * Shows the chart in a frame and fills it with the data file that is specified by the first
   * command line argument.
   *
   * <p>
   *
   * @param args arg[0] has to be a file name of a data file in java.util.Properties format.
  ...
  public static void main(final String[] args) throws IOException {
    ...
    if (!validFile) {
      System.out.println(
          "Missing program argument. Please give the location of a property-file to this program.\n"
   ...
   * @throws IOException if collecting data fails.
   */
