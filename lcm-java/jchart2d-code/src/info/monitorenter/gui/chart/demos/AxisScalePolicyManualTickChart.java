...
/**
 * A minimal example for a chart that has manual configured labels/ticks by using <code>
 * {@link AxisScalePolicyManualTicks}</code>.
 *
 * <p>
 *
...
public final class AxisScalePolicyManualTickChart extends JPanel {
  ...
  private AxisScalePolicyManualTickChart() {
    ...
    // Note that AxixScalePolicyManualTicks should start with the first label with respect to the
    // range policy:
