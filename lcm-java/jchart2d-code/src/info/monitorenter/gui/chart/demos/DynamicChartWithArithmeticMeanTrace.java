...
/**
 * Demonstrates minimal effort to create a dynamic chart with a 2nd trace that displays the
 * arithmetic mean of the last 5 points of the first trace.
 *
 * <p>
 *
...
public final class DynamicChartWithArithmeticMeanTrace {
  ...
  public static void main(final String[] args) {
    ...
    chart
        .getAxisX()
        .setFormatter(new LabelFormatterDate((SimpleDateFormat) DateFormat.getDateTimeInstance()));
