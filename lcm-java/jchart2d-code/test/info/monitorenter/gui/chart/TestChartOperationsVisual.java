...
/**
 * Visual test of operations upon the chart with basic ui for human judgement of success or failure.
 *
 * <p>
 *
...
public class TestChartOperationsVisual extends ATestChartOperations {
  ...
  public static Test suite() {
    ...
    suite.addTest(
        new TestChartOperationsVisual("testAxisLabelFormatterNumberFormatSetNumberFormat"));
  ...
  public void testAddPoint() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.addPoint(50, 110)") {
   ...
   *
   * <p>Bug report http://sourceforge.net/tracker/index.php?func=detail&aid=2605832&
   * group_id=50440&atid=459734: <cite> The effect I can observe is that traces[2] is _not_ removed
   * from the graph (it changes its appearance though, as if it would not be correctly scaled
   * anymore). On the other hand, removing traces[0] or traces[1] instead of traces[2] works as
   * expected!
   *
   * <p>I tried to look inside to figure out what's going on, but I failed; I don't really
   * understand the TreeSetGreedy idea (why is it even there? I'm sure there is a reason for it
   * being more appropriate than a regular TreeSet, but I cannot guess what it is).
   *
   * <p>Maybe this helps: the values for the ComparableProperty (that is, m_zIndex) for the 3 traces
   * are -1, 0, and 1. Are these plausible? </cite>
   */
  public void testAddRemoveTrace() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("add 3 traces, remove last one.") {
          ...
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
          public Object action(final Chart2D chart) {
          ...
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.AChartOperation#createTraces()
           */
          @Override
          ...
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.AChartOperation#preCondition(info.monitorenter.gui.chart.Chart2D)
           */
          @Override
  ...
  /**
   * Sets a new number format to a <code>{@link LabelFormatterNumber}</code> of the y axis.
   *
   * <p>
   */
    ...
    ATestChartOperations.AChartOperation operation =
        new AChartOperation(
          ...
          public Object action(final Chart2D chart) {
            ...
            LabelFormatterNumber labelFormatter =
                (LabelFormatterNumber) chart.getAxisY().getFormatter();
  ...
  /**
   * Invokes <code>{@link IAxis#setFormatter(IAxisLabelFormatter)}</code> on axis x with a <code>
   * {@link LabelFormatterDate}</code>.
   */
  public void testAxisSetLabelFormatter() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation(
            "chart.getAxisX().setFormatter(new LabelFormatterNumber(new SimpleDateFormat(\"HH:mm:ss"
                + " SSS\")))") {
  ...
  /**
   * Tests if creating a chart with one Thread and adding points from another results in deadlocks.
   *
   * <p>
   */
  public void testDeadLockAddPointThread() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("add points from another Thread") {
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
          ...
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.AChartOperation#createChartInstance()
           */
          @Override
        ...
        new AChartOperation(
          ...
          public Object action(final Chart2D chart) {
            ...
            IErrorBarPainter errorBarPainter =
                errorBarPolicy.getErrorBarPainters().iterator().next();
  ...
  public void testRemoveAllPoints() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.removeAllPoints()") {
  ...
  public void testRemoveAllTraces() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("chart.removeAllTraces()") {
  ...
  public void testSetEmptyTraceTitle() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setName(\"\")") {
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
  ...
  public void testSetNullTraceTitle() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setName(null)") {
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
  ...
  /**
   * Sets a new range policy (RangePolicyFixedViewport(new Range(20,30))) to the x axis of the chart
   * and prompts for visual judgement.
   *
   * <p>
   */
  ...
  public void testSetStroke() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setStroke(new BasicStroke(2f))") {
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
  ...
  public void testSetTraceName() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setName(\"Iphigenie\")") {
  ...
  public void testSetTraceNameEmptyTrace() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setName(\"Tauris\") on empty trace") {
  ...
  /**
   * Sets a String title to the trace that has an empty title initially: The label should appear.
   *
   * <p>
   */
  public void testSetTraceTitleOnEmptyTitleTrace() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setName(\"foobar\")") {
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
  ...
  /**
   * Inserts a new TracePoint with an y value <code>{@link Double#NaN}</code> to a sorted trace to
   * get a discontinued trace.
   *
   * <p>
   */
  public void testAddDiscontinuation() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("Inserting a discontinuation: Trace should be split afterwards!") {
          ...
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.AChartOperation#fillTrace(info.monitorenter.gui.chart.ITrace2D)
           */
          @Override
  ...
  public void testSetZIndex() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setZIndex(100)") {
          ...
          public Object action(final Chart2D chart) {
            ...
            while (itTraces.hasNext()) {
              ...
              System.out.println(
                  trace.getName() + " " + trace.getColor() + " : " + trace.getZIndex());
            }
            if (firstTrace != null) {
  ...
  public void testTracePointSetLocation() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("TracePoint2D.setLocation(4,-1)") {
  ...
  /**
   * Invokes <code>{@link ITrace2D#setErrorBarPolicy(IErrorBarPolicy)}</code> with a configuration
   * that should be noticed as a visual change.
   *
   * <p>
   */
  public void testTraceSetErrorBarPolicy() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("trace.setErrorBarPolicy(...)") {
  ...
  public void testZoom() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("zoomableChart.zoom()") {
          /**
           * @see
           *     info.monitorenter.gui.chart.test.ATestChartOperations.IChart2DOperation#action(info.monitorenter.gui.chart.Chart2D)
           */
  ...
  /**
   * Test the following procedure from bug report: https://sourceforge.net/tracker
   ...
   * <ol>
   *   <li>Add a chart.
   *   <li>Add a first trace on a first Y axis.
   *   <li>Add a second trace on a second Y axis.
   *   <li>Add a third trace on a third Y axis.
   *   <li>Add a fourth trace on the first Y axis.
   *   <li>try to remove it.
   * </ol>
   *
   * <p>
  ...
  public void testRemoveTraceForBug2891801() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("testRemoveTraceForBug2891801") {
           ...
           * are added in <code>
           * {@link info.monitorenter.gui.chart.test.ATestChartOperations.AChartOperation#preCondition(Chart2D)}
           * </code>
           *
           * <p>
           *
