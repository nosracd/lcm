...
/**
 * Junit test for <code>{@link info.monitorenter.gui.chart.Chart2D}</code> implementations.
 *
 * <p>
 *
...
public class TestStackedJChart2D extends ATestStackedJChart2D {
  ...
  /**
   * @see
   *     info.monitorenter.gui.chart.test.ATestJChart2D#fillTrace1(info.monitorenter.gui.chart.ITrace2D)
   */
  @Override
  ...
  /**
   * @see
   *     info.monitorenter.gui.chart.test.ATestJChart2D#fillTrace2(info.monitorenter.gui.chart.ITrace2D)
   */
  @Override
