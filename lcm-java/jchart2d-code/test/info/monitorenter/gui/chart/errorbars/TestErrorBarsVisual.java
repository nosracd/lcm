...
/**
 * Visual tests for package <code>{@link info.monitorenter.gui.chart.errorbars}</code>.
 *
 * <p>
 *
...
public class TestErrorBarsVisual extends ATestChartOperations {
  ...
  /**
   * Uses <code>{@link ErrorBarPolicyAbsoluteSummation}</code> and prompts for visual judgment.
   *
   * <p>
   */
  public void testErrorBarPolicyAbsoluteSummation() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("Sets ErrorBarPolicyAbsoluteSummation(0.00001, 10)") {
          /**
           * @see
          ...
          public Object action(final Chart2D chart) {
            ...
            IErrorBarPolicy<?> errorBarPolicy =
                new ErrorBarPolicyAbsoluteSummation(0.00001, 10); // new_err);
