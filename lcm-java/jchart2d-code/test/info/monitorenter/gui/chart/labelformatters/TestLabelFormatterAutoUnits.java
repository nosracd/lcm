...
public class TestLabelFormatterAutoUnits extends ATestChartOperations {
  ...
  /**
   * Checks if the given label formatter uses the femto unit for small numbers (e.g.
   * 0.0000000000000005).
   *
   * <p>
   */
  public void testLabelFormatterAutoUnitsFemto() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("y-axis should have femto prefix") {
  ...
  /**
   * Checks if the given label formatter uses the nano unit for small numbers (e.g.
   * 0.0000000000005).
   *
   * <p>
   */
  public void testLabelFormatterAutoUnitsNano() {
    ATestChartOperations.AChartOperation operation =
        new AChartOperation("y-axis should have nano prefix") {
          /**
           * Sets a {@link LabelFormatterAutoUnits} to the y axis of the chart.
           *
           * <p>
